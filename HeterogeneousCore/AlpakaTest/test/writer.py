...
process.testProducer = SwitchProducerCUDA(
    ...
    cuda = cms.EDAlias(
       testProducerCuda = cms.VPSet(cms.PSet(type = cms.string('128falseportabletestTestSoALayoutvoidvoidvoidvoidvoidPortableHostCollection')),
                                    cms.PSet(type = cms.string('128falseportabletestTestSoALayout128falseportabletestTestSoALayout2voidvoidvoidvoidPortableHostCollection'))
                                   )
