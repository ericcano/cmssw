...
int main() {
  ...
  for (auto const& device : devices) {
    ...
    alpaka::enqueue(queue, alpaka::createTaskKernel<Acc1D>(workDiv, cms::alpakatools::finalizeBulk(), dc_d.data(), a_d.data()));
    ...
    alpaka::enqueue(queue, alpaka::createTaskKernel<Acc1D>(workDiv, cms::alpakatools::finalizeBulk(), dc_d.data(), sa_d.data()));
