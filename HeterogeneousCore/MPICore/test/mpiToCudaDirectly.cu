...
const std::pair<float, float> nonBlockSend(MPIData& mpiInput) 
{
    ...
    //Must be Recieved By Device's Memory [Global DRAM]
      ...
      MPI_Irecv(d_vect1, //Sending to Device memory directly.
    ...
    //  }
      ...
      MPI_Issend(d_vect3Gpu, //Getting data from Device Memory Directly.
                 mpiInput.numberToSend[mpiInput.rank],
                 MPI_FLOAT,
                 root,
                 0,
