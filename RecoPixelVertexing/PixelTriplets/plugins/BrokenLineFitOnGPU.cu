...
void HelixFitOnGPU::launchBrokenLineKernels(HitsView const *hv,
  ...
  for (uint32_t offset = 0; offset < maxNumberOfTuples; offset += maxNumberOfConcurrentFits_) {
    ...
    kernelBLFit<3><<<numberOfBlocks, blockSize, 0, stream>>>(tupleMultiplicity_,
                                                             bField_,
                                                             outputSoa_,
                                                             hitsGPU_.get(),
                                                             hits_geGPU_.get(),
    ...
    kernelBLFit<4><<<numberOfBlocks / 4, blockSize, 0, stream>>>(tupleMultiplicity_,
                                                                 bField_,
                                                                 outputSoa_,
                                                                 hitsGPU_.get(),
                                                                 hits_geGPU_.get(),
    ...
    if (fit5as4_) {
      ...
      kernelBLFit<5><<<numberOfBlocks / 4, blockSize, 0, stream>>>(tupleMultiplicity_,
                                                                   bField_,
                                                                   outputSoa_,
                                                                   hitsGPU_.get(),
                                                                   hits_geGPU_.get(),
